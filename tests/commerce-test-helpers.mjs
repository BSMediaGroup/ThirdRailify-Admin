...
const commerceMigrationUrls = [
  ...
  new URL("../commerce-migrations/0023_wheels_stages_v1.sql", import.meta.url),
  new URL("../commerce-migrations/0024_analytics_and_message_controls.sql", import.meta.url),
  new URL("../commerce-migrations/0025_automations_polls_v1.sql", import.meta.url),
  ...
  new URL("../commerce-migrations/0030_business_profile_compliance_separation.sql", import.meta.url),
  new URL("../commerce-migrations/0031_store_activation_and_agreements.sql", import.meta.url),
  ...
  new URL("../commerce-migrations/0046_poll_permanent_delete.sql", import.meta.url),
  new URL("../commerce-migrations/0047_catalogue_workflow.sql", import.meta.url),
  new URL("../commerce-migrations/0050_wheel_entrant_codes_activity_and_successions.sql", import.meta.url),
];
