...
function customerDetail() { return { ...customersPayload(), customer: { ...guestCustomer(), orders: [{ id: "ord_11111111-1111-4111-8111-111111111111", environment: "test", paymentStatus: "paid", fulfillmentStatus: "disabled", totalAmount: 2500, refundAmount: 0, currencyCode: "CAD", createdAt: "2026-08-29T01:00:00.000Z", paymentConfirmedAt: "2026-08-29T01:01:00.000Z", delivery: { countryCode: "CA", regionCode: "ON", method: "Standard delivery", historicalSnapshot: true }, documentCount: 0, emailCount: 0 }], orderPage: 1, orderPageSize: 20, orderTotalPages: 1, communication: { documents: 0, deliveries: 0, boundedToVisibleOrders: true }, technical: { revision: 1, linkedAccountId: null } } }; }
