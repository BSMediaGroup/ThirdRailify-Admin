...
test("commerce migrations apply in order, with the idempotent foundations repeat-safe", async (t) => {
  ...
  assert.deepEqual(result.results.map((row) => row.name), [
    ...
    "gaming_games", "gaming_media_assets", "gaming_rotation",
    "poll_activity_events", "poll_creator_grants", "poll_media_assets", "poll_options", "poll_rate_limits", "poll_rumble_event_fingerprints", "poll_rumble_leases", "poll_votes", "polls",
