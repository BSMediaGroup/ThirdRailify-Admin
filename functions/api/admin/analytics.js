import { AuthFailure, corsHeaders, errorResponse, jsonResponse, normalizeOrigin } from "../../_shared/auth-core.js";
...
export async function onRequest({ request, env }) {
  try {
    ...
    await requireAdminCapability(env,request,"analytics.view");
