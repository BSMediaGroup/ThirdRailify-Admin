...
export const ADMIN_CAPABILITIES = Object.freeze([
  ...
  definition("workshop.profile_restrictions.manage", "workshop", "Manage Workshop provider-profile restrictions", "Restrict account access to selected provider credential profiles and set account defaults.", { mutable: false, masterOnly: true }),
  ...
  definition("gaming.view", "gaming", "View Gaming", "Inspect the historical Game Library and Current Rotation."),
  definition("gaming.manage", "gaming", "Manage Gaming", "Create and curate games, artwork, Steam mappings, and Current Rotation."),
  ...
  definition("polls.view", "polls", "View Polls", "Inspect Poll definitions, owners, lifecycle, voting policy, and aggregate results."),
  definition("polls.manage", "polls", "Manage Polls", "Manage Poll lifecycle, creator grants, ownership moderation, and Rumble leases."),
  definition("automations.view", "automations", "View Automations", "Inspect bot desired state, heartbeat, safe Rumble runtime, and automation activity."),
  definition("automations.manage", "automations", "Manage Automations", "Change supported versioned bot desired-state settings."),
...
export const ADMIN_CAPABILITY_GROUPS = Object.freeze([
  { id: "workshop", label: "Workshop", description: "Lab use, access administration, provider configuration, and Master-only profile restrictions." },
  ...
  { id: "gaming", label: "Gaming", description: "Game Library, artwork, metadata, and Current Rotation authority." },
  ...
  { id: "polls", label: "Polls", description: "Poll lifecycle, creators, voting, and result authority." },
  { id: "automations", label: "Automations", description: "Discord bot control plane and safe provider runtime." },
