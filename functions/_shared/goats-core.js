...
export async function retryEmail(env, outboxId, actorId, fetchImpl = fetch) {
  ...
  const html = brandedGoatEmailHtml(renderTemplate(row.html_body, variables, true), row.template_key);
...
export function brandedGoatEmailHtml(content, templateKey) {
  const labels = {
  ...
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${escapeHtml(label)}</title><style>@media(max-width:640px){.tr-card{width:100%!important}.tr-pad{padding:28px 22px!important}.tr-title{font-size:34px!important}}.tr-content a{display:inline-block;margin-top:8px;padding:13px 18px;border-radius:6px;background:#f3c928;color:#090907!important;font-weight:800;text-decoration:none}.tr-content h1{margin:0 0 18px;color:#17160f;font-size:36px;line-height:1}.tr-content p{margin:0 0 15px;color:#4d493a;font-size:15px;line-height:1.65}.tr-content strong{color:#17160f}</style></head><body style="margin:0;padding:0;background:#080806;color:#f5f1e5;font-family:Arial,Helvetica,sans-serif"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#080806"><tr><td align="center" style="padding:34px 16px"><table role="presentation" class="tr-card" width="600" cellspacing="0" cellpadding="0" border="0" style="width:600px;max-width:100%;overflow:hidden;border:1px solid #3b351d;border-radius:12px;background:#f3f0e5"><tr><td style="padding:22px 28px;background:#11110e"><table role="presentation" width="100%"><tr><td width="46" valign="middle"><div style="width:38px;height:38px;line-height:38px;border:1px solid #806d19;border-radius:9px;background:#1a180d;color:#f3c928;font-size:24px;text-align:center">&#9889;</div></td><td valign="middle"><strong style="display:block;color:#f5f1e5;font-size:20px;letter-spacing:.04em">THIRD RAILIFY OFFICIAL</strong><span style="display:block;margin-top:3px;color:#b7b19d;font-size:10px;letter-spacing:.16em;text-transform:uppercase">GOATS in the Wild</span></td></tr></table></td></tr><tr><td height="5" style="height:5px;background:#f3c928"></td></tr><tr><td class="tr-pad" style="padding:38px 42px"><div style="margin-bottom:12px;color:#9b7c05;font-size:11px;font-weight:800;letter-spacing:.14em;text-transform:uppercase">${escapeHtml(label)}</div><div class="tr-content">${String(content || "")}</div></td></tr><tr><td style="padding:20px 28px;border-top:1px solid #d5cebb;background:#e8e3d4;color:#655f4c;font-size:12px;line-height:1.55"><strong style="color:#3f3b2e">Third Railify Official</strong><br>Community stories are reviewed before publication. Locations shown publicly are deliberately approximate.</td></tr></table><div style="padding:18px 8px;color:#77715f;font-size:10px;line-height:1.5">This transactional message was generated by the Admin-authoritative GOATS workflow.</div></td></tr></table></body></html>`;
}
