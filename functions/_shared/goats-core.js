...
function adminOrigin(env) {
  return normalizeOrigin(env?.THIRDRAILIFY_ADMIN_ORIGIN) || "https://admin.thirdrailify.com";
}

function publicOrigin(env) {
  return normalizeOrigin(env?.THIRDRAILIFY_PUBLIC_ORIGIN) || "https://thirdrailify.com";
}
...
export function brandedGoatEmailHtml(content, templateKey, origin = "https://admin.thirdrailify.com") {
  const labels = {
  ...
  const assetOrigin = normalizeOrigin(origin) || "https://admin.thirdrailify.com";
