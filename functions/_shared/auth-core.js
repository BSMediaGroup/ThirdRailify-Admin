...
const RATE_RULES = {
  ...
  commerce_catalogue_mutation: { limit: 240, windowSeconds: 60 * 60, blockSeconds: 15 * 60 },
  ...
  "paypal-webhook": { limit: 480, windowSeconds: 60 * 60, blockSeconds: 15 * 60 },
  ...
  gaming_igdb_lookup: { limit: 60, windowSeconds: 60 * 60, blockSeconds: 15 * 60 },
  gaming_steam_lookup: { limit: 60, windowSeconds: 60 * 60, blockSeconds: 15 * 60 },
};
