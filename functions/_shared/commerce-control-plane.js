...
export async function paymentsControlPlanePayload(env, session) {
  ...
  const paypalProductionActive = paypalProductionReady && settings.paypal_live_capture_enabled === true && (settings.paypal_store_checkout_enabled === true || settings.paypal_donations_enabled === true);
