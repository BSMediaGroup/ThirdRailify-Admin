...
$migrationName = '0049_rumble_intelligence_rollups.sql'
...
$backup = 'X:\GIT\_BACKUPS\ThirdRailify\d1-read-incident-20260914-000715\commerce-before.sql'
$backupBytes = 6900631
$backupHash = '7EEFF6CE24D5C741A0712A77030D0DD9BC7B1482F192063EC54541A8846D8FAD'
$migrationHash = '0BBABDB02600C7F1D44A65BD622DB3DB2437564C561F29B6D77BCA3050298301'
...
$release = Join-Path $repo '.artifacts\d1-read-incident\migration'
...
& $node $wrangler d1 execute thirdrailify-commerce --remote --config $configPath --command "SELECT name,type FROM sqlite_master WHERE name IN ('rumble_intelligence_sources','rumble_intelligence_rollups'); PRAGMA table_info(rumble_intelligence_rollups); PRAGMA foreign_key_check; SELECT name FROM d1_migrations WHERE name='$migrationName';" --json
