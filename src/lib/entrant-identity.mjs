...
export const EVENT_ENTRY_TYPES = Object.freeze({ 'rumble.chat.exact': 'chat', 'rumble.follow': 'follow', 'rumble.subscribe': 'subscription', subscriber_self_paid: 'subscription', 'rumble.gift_purchase': 'gift', 'rumble.raid.received': 'raid', 'rumble.rant': 'rant' });
