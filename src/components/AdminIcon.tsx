...
const paths: Record<Props["name"], ReactNode> = {
  ...
  gaming: <><path d="M7 9h10c2 0 3.5 1.4 4 3.4l1 4.2c.5 2.1-2 3.5-3.5 2l-2.3-2.3H7.8l-2.3 2.3c-1.5 1.5-4-.1-3.5-2.1l1-4.1C3.5 10.4 5 9 7 9Z"/><path d="M8 12v4M6 14h4M15.5 13h.01M18 15h.01"/></>,
  ...
  wheelStages: <><circle cx="6.5" cy="6.5" r="3.5"/><circle cx="17.5" cy="6.5" r="3.5"/><circle cx="6.5" cy="17.5" r="3.5"/><circle cx="17.5" cy="17.5" r="3.5"/></>,
  bracket: <><path d="M3 4h5v5H3M3 15h5v5H3M8 6.5h5v11H8M13 12h8"/></>,
  versus: <><path d="M3 6h4l4 6-4 6H3M21 6h-4l-4 6 4 6h4"/></>,
