  ...
  return <section className="ri-trend" aria-label="Rumble subscriber trend" aria-busy={loading}>
    ...
    <div className="ri-trend__plot" ref={plotRef} onMouseLeave={() => setActive(null)}>
      <svg viewBox={`0 0 ${plotWidth} 265`} role="img" aria-label={`Subscriber counts across ${range}; ${points.length} recorded observations`}>
        ...
        <defs><linearGradient id={`${id}-fill`} x1="0" y1="0" x2="0" y2="1"><stop offset="0" stopColor="#6dce38" stopOpacity=".26" /><stop offset="1" stopColor="#6dce38" stopOpacity="0" /></linearGradient><linearGradient id={`${id}-stroke`} gradientUnits="userSpaceOnUse" x1={left} y1="0" x2={right} y2="0"><stop stopColor="#48ad2d" /><stop offset=".55" stopColor="#a0f16b" /><stop offset="1" stopColor="#73d03c" /></linearGradient></defs>
