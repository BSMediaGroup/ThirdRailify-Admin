    ...
    {payload && <>
      <section className="fulfillment-hero" aria-labelledby="fulfillment-readiness-title">
        <div className="fulfillment-hero__intro">
          ...
          <div className="fulfillment-hero__answers"><Answer label="Create a provider order?" value="No — preview only" /><Answer label="Fulfill a customer order?" value="No — dependencies blocked" /><Answer label="Anything submitted?" value={payload.evidence.counts.providerOrders ? `${payload.evidence.counts.providerOrders} local record(s)` : "No provider orders recorded"} /></div>
        </div>
      ...
      <section className="fulfillment-section fulfillment-draft" aria-labelledby="draft-title">
        ...
        <div className="fulfillment-draft__grid">
          <article>
            ...
            <button type="button" disabled aria-describedby="provider-submit-reason">Submit to Printful — unavailable</button><p id="provider-submit-reason">This milestone exposes no provider-write control. Submission remains disabled regardless of preview structure.</p>
          </article>
