...
export function SiteContentPage() {
  ...
  return (
    <section className="site-content-page" aria-labelledby="site-content-title">
      <header className="content-admin-heading"><div><p className="section-kicker">Site content / announcements</p><h1 id="site-content-title">Public banner</h1><p>Configure the normal announcement rail and the presentation used only when Watch confirms a genuine live broadcast.</p></div><a className="secondary-button" href="https://thirdrailify.pages.dev/" target="_blank" rel="noreferrer">Open Public site <AdminIcon name="external" size={15} /></a></header>
